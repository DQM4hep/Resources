...
New experiments from other collaborations such as the DREAM calorimeter from RD52 have shown their interest and started integrated this solution.
Work on coupling with the generic data acquisition framework EUDAQ~\cite{EUDAQ} have also started.
Such integration would provide powerful, almost off-the-shelf, sets of tools for experiments to acquire and assess quality of their data.  
